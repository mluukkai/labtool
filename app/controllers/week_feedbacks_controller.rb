  ...
  def create
    ...
    if week_feedback.valid?
      ...
      if params[:notify]
        ...
        NotificationMailer.email(reviewer.email, student.email, "ks. #{mypage_path+'/'+student.student_number}", "viikon #{week_feedback.week} palaute", params['notify-cc'], Course.active.name).deliver
      end
